    ...
    <div className="flex flex-col gap-3 rounded-2xl border border-border bg-bg-raised p-4">
      ...
      {result.tourContentId && (
        <Link
          ...
          className="flex w-full items-center justify-center rounded-full bg-primary px-6 py-3 text-[15px] font-semibold text-white transition-colors hover:bg-primary-hover"
        >
          상세정보 보기
        </Link>
      )}
